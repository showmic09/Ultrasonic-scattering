...
function []=omega_3_calc(directory,file_name_part)
featureID_dataset='/DataContainers/SyntheticVolumeDataContainer/CellData/FeatureIds';
cd(directory);
d=dir(file_name_part);
file_dir=fullfile(directory,d(1).name);
...
toc;
save('omega3_','omega_3_bar'); %%omega_3_bar is the omega3 that is used in DREAM.3D
